...
const CatalogMap = dynamic(() => import('./CatalogMap'), {
  ssr: false,
  loading: () => (
    <div className="w-full h-[400px] sm:h-[500px] lg:h-[650px] rounded-3xl bg-slate-900/90 border border-slate-800 flex flex-col items-center justify-center space-y-3 text-white">
