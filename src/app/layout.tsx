...
export const metadata: Metadata = {
  ...
  other: {
    ...
    'business:contact_data:street_address': '25 de Mayo 338',
    'business:contact_data:locality': 'San José de Mayo',
    'business:contact_data:region': 'San José',
    'business:contact_data:postal_code': '80000',
    'business:contact_data:country_name': 'Uruguay',
    'ai-catalog': `${BASE_URL}/.well-known/ai-catalog.json`,
    'ai-full-manifest': `${BASE_URL}/llms-full.txt`,
