...
export async function PUT(
  ...
  try {
    ...
    const updatedProperty = {
      ...
      location: {
        department: body.department || body.location?.department || existing.location.department || 'San José',
        city: body.city || body.location?.city || existing.location.city || 'San José de Mayo',
        neighborhood: body.neighborhood || body.location?.neighborhood || existing.location.neighborhood || 'Centro',
        zone: body.zone || body.location?.zone || existing.location.zone || undefined,
        address: body.address !== undefined ? body.address : existing.location.address,
        coordinates: {
          lat: body.lat !== undefined ? Number(body.lat) : (body.location?.coordinates?.lat ?? existing.location.coordinates?.lat ?? -34.3375),
          lng: body.lng !== undefined ? Number(body.lng) : (body.location?.coordinates?.lng ?? existing.location.coordinates?.lng ?? -56.7136),
        },
        isExactLocation: body.isExactLocation !== undefined ? body.isExactLocation : (body.location?.isExactLocation ?? existing.location.isExactLocation ?? false),
        radiusMeters: body.radiusMeters !== undefined ? Number(body.radiusMeters) : (body.location?.radiusMeters || existing.location.radiusMeters || 300),
        hasLocation: body.hasLocation !== undefined ? body.hasLocation : (body.location?.hasLocation !== undefined ? body.location.hasLocation : existing.location.hasLocation),
      },
      features: {
        ...
        coneatIndex: body.coneatIndex !== undefined ? (body.coneatIndex ? Number(body.coneatIndex) : undefined) : (body.features?.coneatIndex !== undefined ? (body.features.coneatIndex ? Number(body.features.coneatIndex) : undefined) : existing.features?.coneatIndex),
        ...
        hectaresAmount: body.hectaresAmount !== undefined ? (body.hectaresAmount ? Number(body.hectaresAmount) : undefined) : (body.features?.hectaresAmount !== undefined ? (body.features.hectaresAmount ? Number(body.features.hectaresAmount) : undefined) : existing.features?.hectaresAmount),
        ...
        priceUnitType: body.priceUnitType !== undefined ? body.priceUnitType : (body.features?.priceUnitType !== undefined ? body.features.priceUnitType : existing.features?.priceUnitType || 'm²'),
        ...
        cadastralNumber: body.cadastralNumber !== undefined ? body.cadastralNumber : (body.features?.cadastralNumber !== undefined ? body.features.cadastralNumber : existing.features?.cadastralNumber),
        propertyTaxUpToDate: body.propertyTaxUpToDate !== undefined ? Boolean(body.propertyTaxUpToDate) : (body.features?.propertyTaxUpToDate !== undefined ? Boolean(body.features.propertyTaxUpToDate) : existing.features?.propertyTaxUpToDate ?? true),
        primaryTaxUpToDate: body.primaryTaxUpToDate !== undefined ? Boolean(body.primaryTaxUpToDate) : (body.features?.primaryTaxUpToDate !== undefined ? Boolean(body.features.primaryTaxUpToDate) : existing.features?.primaryTaxUpToDate ?? true),
      },
