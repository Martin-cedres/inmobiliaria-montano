  ...
  try {
    ...
    const updatedProperty = {
      ...
      features: {
        ...
        carAccess: body.carAccess !== undefined ? body.carAccess : existing.features.carAccess,
        ...
        garden: body.garden !== undefined ? body.garden : existing.features.garden,
        woodStoveOrAC: body.woodStoveOrAC !== undefined ? body.woodStoveOrAC : existing.features.woodStoveOrAC,
        petFriendly: body.petFriendly !== undefined ? body.petFriendly : existing.features.petFriendly,
        ...
        uteElectric: body.uteElectric !== undefined ? body.uteElectric : existing.features.uteElectric,
        ...
        titlesUpToDate: body.titlesUpToDate !== undefined ? body.titlesUpToDate : existing.features.titlesUpToDate,
        acceptsTradeIn: body.acceptsTradeIn !== undefined ? body.acceptsTradeIn : existing.features.acceptsTradeIn,
        securitySystem: body.securitySystem !== undefined ? body.securitySystem : existing.features.securitySystem,
